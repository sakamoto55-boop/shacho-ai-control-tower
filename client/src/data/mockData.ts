...
export const mockAiResponses: Record<string, Record<string, string>> = {
  secretary: {
    Gmail: '**デモGmailを確認しました。要対応は5件です。**\n\n🔴 優先度A — 2件（本日中）\n1. 【至急】融資審査追加書類の提出（○○銀行 / 本日中 / 銀行）\n2. B現場 追加外注費の承認依頼（加藤監督 / 今日中 / ¥480,000）\n\n🟡 優先度B — 3件（今週中）\n3. 工事代金の未払い連絡（A社 経理部 / 今週中 / 請求）\n4. 労働安全衛生法 書類提出依頼（監督署 / 7月10日 / 行政）\n5. 契約書内容確認のお願い（B社 田中 / 今週中 / 契約）\n\n返信文たたき台は5件とも作成済みです。「要対応」画面 → Gmailセクションからご確認ください。\n\n⚠️ 元データ：デモGmail · 本番Gmail未接続 · 返信未送信 · Gmailに書き込みなし',
    返信: '**返信が必要なメール（優先順）：**\n\n🔴 最優先（本日中）\n1. ○○銀行 山田様 — 融資審査追加書類\n   → 試算表・売掛金一覧・取引先一覧を準備して送付\n2. 加藤監督 — B現場外注費¥480,000承認\n   → 承認/否認を今日中に連絡\n\n🟡 今週中\n3. A社 鈴木様 — 工事代金¥2,850,000の支払確認\n4. B社 田中様 — 契約書署名・返送\n5. 監督署 — 健康診断書類（7/10まで）\n\n返信文たたき台は「要対応」画面 → Gmailセクションから確認・コピーできます。\n⚠️ Gmailには送信・保存されていません。手動でお送りください。',
    銀行: '**銀行からのメール（デモGmail）：**\n\n📧 件名：【至急】融資審査に係る追加書類の提出について\n👤 送信者：○○銀行 法人営業部 山田様\n⏰ 期限：本日中\n🔴 優先度：A（最優先）\n\n■ 提出必要書類\n・直近3ヶ月の試算表\n・売掛金一覧表\n・主要取引先一覧\n\n■ 返信文たたき台\n「ご連絡ありがとうございます。本日中に必要書類を準備してご送付いたします。」\n\n「要対応」画面から返信文をコピーして手動送信してください。\n⚠️ Gmailへの送信・下書き保存は行っていません。',
    今日中: '**今日中に対応が必要なメール（デモGmail）：**\n\n🔴 2件が今日中の期限です\n\n① 【最優先】融資審査追加書類の提出\n→ ○○銀行 山田様 / 本日中が期限\n→ 試算表・売掛金一覧・取引先一覧を今日中に送付\n→ 書類準備後、コピーした返信文を手動送信\n\n② B現場 追加外注費¥480,000の承認判断\n→ 加藤監督 / 今日中に決定しないと明日の工程が停止\n→ 社長が承認/否認を判断して連絡\n\n残り3件（A社・B社・監督署）は今週中の対応です。',
    返信文: '**返信文たたき台の確認方法（デモGmail）：**\n\n全5件の返信文たたき台が作成済みです。\n\n確認手順：\n1. 「今日の要対応」画面を開く\n2. 「Gmailからの要対応」セクションを展開\n3. 返信したいメールの「詳細・返信文たたき台を見る」をタップ\n4. 内容確認後「返信文をコピー」ボタンでコピー\n5. GmailまたはメールアプリにペーストしてOK\n\n⚠️ 送信ボタンはありません。これは下書き案です。\nGmailには保存・送信されていません。必ず内容を確認して手動でお送りください。',
    今日: '**今日のやるべきこと（秘書モード）：**\n\n🔴 午前中に必ず対応\n1. 三菱UFJ 佐藤担当へ書類提出\n2. 田中建設 田中部長に電話\n3. 現場事故の加藤監督へ連絡\n\n📧 Gmailからも要対応あり\n4. 融資審査追加書類（銀行・本日中）\n5. B現場外注費承認（加藤監督・今日中）\n\n📋 午後\n6. freee入金確認\n7. 山田設備の見積り確認待ち\n\n📝 今週中\n8. 外注単価交渉の方針決定\n9. 研修日程の承認',
